...
return [
    ...
    'attributes' => [
        ...
        'rds_database_id' => 'RDS-Datenbank',
        'server_id' => 'Server',
        'is_primary' => 'primäre Datenbank',
        'db_instance_identifier' => 'DB-Instanz-Kennung',
        'engine' => 'Datenbank-Engine',
        'engine_version' => 'Engine-Version',
        'db_instance_class' => 'DB-Instanz-Klasse',
        'db_name' => 'Datenbankname',
        'master_username' => 'Master-Benutzername',
        'master_password' => 'Master-Passwort',
        'allocated_storage' => 'zugewiesener Speicher',
        'storage_type' => 'Speichertyp',
        'multi_az' => 'Multi-AZ-Bereitstellung',
        'publicly_accessible' => 'öffentlich zugänglich',
        'backup_retention_period' => 'Backup-Aufbewahrungszeitraum',
        'vpc_security_group' => 'VPC-Sicherheitsgruppe',
        'storage_encrypted' => 'Speicherverschlüsselung',
    ],
];
